...
# Candy
![GitHub Repo stars](https://img.shields.io/github/release/lanthora/candy)
![](https://img.shields.io/github/actions/workflow/status/lanthora/candy/release.yaml)
![](https://img.shields.io/github/contributors-anon/lanthora/candy)
![](https://img.shields.io/github/issues-raw/lanthora/candy)
![](https://img.shields.io/github/issues-pr-raw/lanthora/candy)
...
该程序由[交叉编译脚本](https://github.com/lanthora/candy/blob/master/scripts/build-standalone.sh)构建.
...
根据实际情况设置以下环境变量,查看[受支持的系统和架构](https://github.com/lanthora/candy/blob/master/scripts/standalone.json).
...
详细用法请参考[配置文件](https://github.com/lanthora/candy/blob/master/candy.cfg)和[文档](https://docs.canets.org).
...
以 Linux 发行版 [Service](https://github.com/lanthora/candy/blob/master/candy.service) 的方式接入测试网络
